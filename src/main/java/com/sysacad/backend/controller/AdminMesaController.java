...
public class AdminMesaController {
    ...
    public ResponseEntity<com.sysacad.backend.dto.mesa_examen.MesaExamenResponse> obtenerTurno(@PathVariable UUID id) {
        return ResponseEntity.ok(mesaService.obtenerTurnoPorId(id));
    }
