...
public class UTNSeeder {
    ...
    private List<MateriaDef> getDatasetISI() {
        return List.of(
                ...
                new MateriaDef("23", "Diseño de Sistemas de Información", 6, "ANUAL", 3, false, List.of("9", "14", "16")),
                // Nivel 4
                ...
                new MateriaDef("30", "Administración de Sistemas de Información", 6, "ANUAL", 4, false, List.of("18", "23")),
                // Nivel 5
                ...
                new MateriaDef("51", "Metodologías Ágiles en el Desarrollo de Software", 3, "CUATRIMESTRAL", 4, true, List.of("25")),
                ...
                new MateriaDef("54", "Informática en la Administración Pública", 4, "CUATRIMESTRAL", 5, true, List.of()),
                new MateriaDef("55", "Sistemas de Información Integrados para la Industria", 4, "CUATRIMESTRAL", 5, true, List.of("25", "27", "30")),
    ...
    private List<MateriaDef> getDatasetCivil() {
        return List.of(
                ...
                new MateriaDef("20", "Hidráulica General y Aplicada", 5, "ANUAL", 3, false, List.of("9", "10", "11", "13")),
                new MateriaDef("21", "Cálculo Avanzado", 2, "ANUAL", 3, false, List.of("9", "10", "12")),
                new MateriaDef("22", "Instalaciones Eléctricas y Acústicas", 2, "ANUAL", 3, false, List.of("11", "12", "13")),
                ...
                new MateriaDef("27", "Instalaciones Sanitarias y de Gas", 3, "ANUAL", 4, false, List.of("18", "19", "20", "24")),
                new MateriaDef("28", "Diseño Arquitec., Planeamiento y Urbanismo", 5, "ANUAL", 4, false, List.of("18", "19", "22", "23", "24", "25")),
                new MateriaDef("29", "Análisis Estructural I", 5, "ANUAL", 4, false, List.of("16", "17")),
                new MateriaDef("30", "Estructuras de Hormigón", 5, "ANUAL", 4, false, List.of("16", "17", "18", "19", "25")),
                new MateriaDef("31", "Hidrología y Obras Hidráulicas", 4, "ANUAL", 4, false, List.of("16", "18", "19", "20", "24", "25")),
                new MateriaDef("32", "Ingeniería Legal", 3, "ANUAL", 4, false, List.of("9", "11", "14", "15")),
                new MateriaDef("33", "Construcciones Metálicas y de Maderas", 4, "ANUAL", 4, false, List.of("21", "29")),
                // Nivel 5
    ...
    private List<MateriaDef> getDatasetQuimica() {
        return List.of(
                ...
                new MateriaDef("27", "Diseño, simulación, optimización y seg.", 4, "ANUAL", 3, false, List.of("17", "19")),
                // Nivel 4
                new MateriaDef("28", "Operaciones Unitarias I", 5, "ANUAL", 4, false, List.of("17", "18", "22")),
                new MateriaDef("29", "Tecnología de la Energía Térmica", 5, "ANUAL", 4, false, List.of("17", "18", "21", "22")),
                ...
                new MateriaDef("32", "Ingeniería de las Reacciones Químicas", 5, "ANUAL", 4, false, List.of("17", "18", "21", "22")),
    ...
    private List<MateriaDef> getDatasetMecanica() {
        return List.of(
                ...
                new MateriaDef("14", "Ingeniería Ambiental y Seguridad Industrial", 3, "ANUAL", 2, false, List.of("2", "4")),
                ...
                // Nivel 4
                new MateriaDef("27", "Elementos de Máquinas", 5, "ANUAL", 4, false, List.of("9", "11", "18", "19", "23")),
                new MateriaDef("28", "Tecnología del Calor", 3, "ANUAL", 4, false, List.of("17")),
                new MateriaDef("29", "Metrología e Ingeniería de la Calidad", 4, "ANUAL", 4, false, List.of("20", "24")),
                ...
                new MateriaDef("32", "Electrónica y Sistemas de Control", 5, "ANUAL", 4, false, List.of("12", "13", "22")),
                ...
                new MateriaDef("36", "Instalaciones Industriales", 5, "ANUAL", 5, false, List.of("20", "28", "30", "31", "32")),
                ...
                new MateriaDef("44", "Sistemas de Control en Instalaciones Térmicas", 3, "ANUAL", 5, true, List.of("17", "30")),
    ...
    private List<MateriaDef> getDatasetElectrica() {
        return List.of(
                ...
                new MateriaDef("37", "Generación, Transmisión y Distr. de Energía", 6, "ANUAL", 5, false, List.of("12", "13", "18", "22", "23", "24")),
                ...
                new MateriaDef("50", "Transmisión de Datos en Sistemas Eléctricos", 2, "ANUAL", 5, true, List.of("11", "29")),
